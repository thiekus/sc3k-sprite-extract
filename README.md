...
## License
Most of code of this project is licensed under the terms of the [MIT License](https://github.com/thiekus/sc3k-sprite-extract/blob/main/LICENSE), with exception is `minilzo.pas` which port of [minilzo](https://www.oberhumer.com/opensource/lzo/) to Pascal, licensed under [GPL v2 or later](https://github.com/thiekus/sc3k-sprite-extract/blob/main/LICENSE.GPL). Therefore, resulted built of whole program is licensed as GPL v2 or later as well unless minilzo code part striped from built program.
